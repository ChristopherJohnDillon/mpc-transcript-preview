...
const METHOD_HTML = "\n<header><div class=\"wrap\">\n  <p class=\"eyebrow\">My Perfect Console</p>\n  <h1>How this was made</h1>\n  <p class=\"byline\">Nothing here was typed out by hand. Here's what did it, and what it gets\n     wrong.</p>\n</div></header>\n<nav class=\"wrap nav\"><a href=\"index.html\">Transcripts</a><a href=\"stats.html\">Numbers</a>\n  <a href=\"method.html\" aria-current=\"page\">How</a></nav>\n<main class=\"wrap stats\">\n  <p class=\"lede\">Every episode goes through the same few steps. All of it runs on ordinary\n     M-chip Macs sitting on a desk &mdash; no audio is uploaded anywhere, and no transcription\n     service ever sees the show.</p>\n\n  <h2>Hearing the words</h2>\n  <p class=\"note\">Two different speech recognisers listen to each episode: OpenAI's Whisper,\n     running locally, and the recogniser built into macOS. They're good at different things and\n     they fail differently, which is the whole reason for running both. Where they agree, you can\n     be fairly confident. Where they disagree, the software has to decide, and it leans on a third\n     check &mdash; forced alignment, which goes back to the waveform and asks whether the audio\n     really contains the words somebody claims to have heard.</p>\n  <p class=\"note\">That check earns its keep. Speech recognisers hallucinate when there's nothing\n     to hear: over the theme music, in a pause, under a game's trailer. They'll write \"Thank you.\"\n     a dozen times, or repeat a phrase until the music stops. Those get caught and set aside\n     rather than deleted, so nothing is lost, and one engine's version of a passage can be swapped\n     for the other's when it's plainly better.</p>\n\n  <h2>Working out who's speaking</h2>\n  <p class=\"note\">A separate pass splits the audio by voice, then a voiceprint matches those\n     voices to names. Simon appears in every episode, so he's easy; a guest is learned from the\n     episode itself. It's good, not perfect. Short interjections get misattributed, and when two\n     people talk over each other the labels can land on the wrong side of a sentence.</p>\n\n  <h2>Finding the five games</h2>\n  <p class=\"note\">The show's own records say which five games a guest picked. The transcript is\n     asked a much easier question: where in the episode is each one named? A game announcement has\n     a signature &mdash; the guest names it, and a clip of its music plays a few seconds later\n     &mdash; so the search looks for the title near a burst of music, and falls back to the first\n     time it's spoken.</p>\n  <p class=\"note\">Getting this right is mostly about spelling. The records say \"Pok&eacute;mon\n     Crystal\" and the audio says \"Pokemon Crystal\"; the records say \"Wizards &amp; Warriors\" and\n     the guest says \"Wizards and Warriors\"; whisper hears \"Caves of Cud\" for Caves of Qud and\n     \"fantasy star online\" for Phantasy Star Online. Every one of those has to be reconciled\n     before a game can be found at all. About one pick in sixteen still can't be placed &mdash;\n     usually because the guest never quite says the title out loud.</p>\n\n  <h2>What to expect</h2>\n  <p class=\"note\">These are machine transcripts and they read like it in places. Names are the\n     weakest part: an unfamiliar surname or a game nobody has heard of will often come out\n     phonetically. Speaker labels are occasionally wrong. Timings are close but not exact.</p>\n  <p class=\"note\">Two things are worth knowing if you're comparing against the audio. Timestamps\n     are measured against the ad-free version, so they'll drift against the public feed. And only\n     openly released episodes are here &mdash; Patreon episodes aren't included, and their text\n     isn't stored anywhere in this site.</p>\n\n  <h2>Numbers</h2>\n  <p class=\"note\">Everything on the Numbers page comes out of these transcripts, so it carries\n     the same errors. Word counts are counted words, and speaking shares are shares of those\n     words rather than of measured seconds. Release years and review scores come from IGDB, and\n     the picks themselves are the show's own list rather than anything inferred.</p>\n</main>\n<footer class=\"wrap\">\n  <p>Built by <a href=\"https://christopherdillon.me\">Chris Dillon</a>. Transcribed automatically\n     from the published episode audio.</p>\n</footer>\n";
