...
function renderStats(d){
  const t = d.transcripts, p = d.picks;
  ...
  let h = '<header><div class="wrap">'
    ...
    + '<nav class="nav"><a href="' + ROOT + '">Transcripts</a>'
    ...
    + '<li class="figure"><b>' + fmt(t.words) + '</b><span>words spoken</span></li>'
